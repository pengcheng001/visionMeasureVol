...
void Getxyz2(std::vector<cv::Point2f> point,short distance,float &Length,float &Width);
unsigned short calculateDepthFromDepthImagInRangeCountour(cv::Mat &depthIamge, std::vector<cv::Point> &contour,double &confidence);
